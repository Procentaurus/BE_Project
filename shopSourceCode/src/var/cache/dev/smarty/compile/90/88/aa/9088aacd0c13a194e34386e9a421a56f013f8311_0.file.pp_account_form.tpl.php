...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6553a1f7eb43c0_47703218',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9088aacd0c13a194e34386e9a421a56f013f8311' => 
    array (
...
function content_6553a1f7eb43c0_47703218 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_11412321866553a1f7e8e6c9_89465661', 'form_content');
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1087508046553a1f7eb2423_95326627', 'form_footer_buttons');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "./form.tpl");
}
/* {block 'form_content'} */
class Block_11412321866553a1f7e8e6c9_89465661 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'form_content' => 
  array (
    0 => 'Block_11412321866553a1f7e8e6c9_89465661',
  ),
);
...
$_smarty_tpl->_assignInScope('selectMode', array('type'=>'select','name'=>'mode','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['mode'])===null||$tmp==='' ? '' : $tmp),'options'=>array(array('value'=>'LIVE','title'=>$_prefixVariable15),array('value'=>'SANDBOX','title'=>$_prefixVariable16)),'label'=>$_prefixVariable17,'variant'=>'primary'));?>
            <?php ob_start();
...
$_smarty_tpl->_assignInScope('clientIdLive', array('type'=>'text','name'=>'paypal_clientid_live','label'=>$_prefixVariable18,'variant'=>'primary','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['paypal_clientid_live'])===null||$tmp==='' ? '' : $tmp)));?>
            <?php ob_start();
...
$_smarty_tpl->_assignInScope('clientSecretLive', array('type'=>'text','name'=>'paypal_secret_live','label'=>$_prefixVariable19,'variant'=>'primary','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['paypal_secret_live'])===null||$tmp==='' ? '' : $tmp)));?>
            <?php ob_start();
...
$_smarty_tpl->_assignInScope('merchantIdLive', array('type'=>'text','name'=>'merchant_id_live','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['merchant_id_live'])===null||$tmp==='' ? '' : $tmp),'label'=>$_prefixVariable20,'variant'=>'primary'));?>
            <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Client\’s ID','mod'=>'paypal'),$_smarty_tpl ) );
$_prefixVariable21=ob_get_clean();
$_smarty_tpl->_assignInScope('clientIdSandbox', array('type'=>'text','name'=>'paypal_clientid_sandbox','label'=>$_prefixVariable21,'variant'=>'primary','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['paypal_clientid_sandbox'])===null||$tmp==='' ? '' : $tmp)));?>
            <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Client\’s secret','mod'=>'paypal'),$_smarty_tpl ) );
$_prefixVariable22=ob_get_clean();
$_smarty_tpl->_assignInScope('clientSecretSandbox', array('type'=>'text','name'=>'paypal_secret_sandbox','label'=>$_prefixVariable22,'variant'=>'primary','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['paypal_secret_sandbox'])===null||$tmp==='' ? '' : $tmp)));?>
            <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Merchant ID','mod'=>'paypal'),$_smarty_tpl ) );
$_prefixVariable23=ob_get_clean();
$_smarty_tpl->_assignInScope('merchantIdSandbox', array('type'=>'text','name'=>'merchant_id_sandbox','value'=>(($tmp = @$_smarty_tpl->tpl_vars['field']->value['set']['merchant_id_sandbox'])===null||$tmp==='' ? '' : $tmp),'label'=>$_prefixVariable23,'variant'=>'primary'));?>
...
class Block_1087508046553a1f7eb2423_95326627 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'form_footer_buttons' => 
  array (
    0 => 'Block_1087508046553a1f7eb2423_95326627',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
