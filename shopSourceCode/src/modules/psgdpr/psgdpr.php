...
class Psgdpr extends Module
{
    ...
    private $presetMessageAccountCustomer = [
        ...
        'pl' => 'Przesyłając ten formularz, wyrażam zgodę na wykorzystywanie wprowadzonych danych przez Centrum Rowerowe, aby umożliwić: (I) zapoznanie się z moją prośbą, (II) udzielenie odpowiedzi oraz, w stosownych przypadkach, (III) zapewnić zarządzanie stosunkiem umownym, który może z tego wyniknąć.',
    ...
    public function addModuleConsent($module)
    {
        ...
        $moduleConsent->message = 'Akceptuje warunki i chce zapisac sie na newseller';
